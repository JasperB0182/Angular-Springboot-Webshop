...
import com.s1155772.webshop.dao.CategoryRepository;
...
public class Seeder {
    ...
    public Seeder(CategoryRepository categoryRepository, ProductsRepository productsRepository, BrandRepository brandRepository) {
